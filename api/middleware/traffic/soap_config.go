...
type SOAPBody struct {
	GetAllTransactionsRequest          *GetAllTransactionsRequest          `xml:"tns:GetAllTransactionsRequest"`
	GetAllTransactionsResponse         *GetAllTransactionsResponse         `xml:"tns:GetAllTransactionsResponse"`
	GetTransactionByIDRequest          *GetTransactionByIDRequest          `xml:"tns:GetTransactionByIDRequest,omitempty"`
	GetTransactionByIDResponse         *GetTransactionByIDResponse         `xml:"tns:GetTransactionByIDResponse,omitempty"`
	GetTransactionsByAccountIDRequest  *GetTransactionsByAccountIDRequest  `xml:"tns:GetTransactionsByAccountIDRequest,omitempty"`
	GetTransactionsByAccountIDResponse *GetTransactionsByAccountIDResponse `xml:"tns:GetTransactionsByAccountIDResponse,omitempty"`
}
...
type GetTransactionByIDRequest struct {
	XMLName       xml.Name `xml:"tns:GetTransactionByIDRequest"`
	TransactionID string   `xml:"tns:TransactionID"`
}
...
type GetTransactionsByAccountIDRequest struct {
	XMLName   xml.Name `xml:"tns:GetTransactionsByAccountIDRequest"`
	AccountID string   `xml:"tns:AccountID"`
}
